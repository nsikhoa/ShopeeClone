...
export default function Cart() {
  ...
  const checkedPurchasesCount = checkedPurchase.length
      ...
      <div className='container'>
        {extendedPurchase.length > 0 ? (
          <>
            ...
            <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border-gray-100 bg-white p-5 shadow sm:flex-grow sm:flex-row sm:items-center'>
              <div className='flex items-center'>
                <div className='flex flex-shrink-0 items-center justify-center pr-3'>
                  <input
                    type='checkbox'
          ...
          <div className='text-center'>
            ...
            <div className='font-bold-700 mt-5 px-2 text-gray-500'>Giỏ hành của bạn còn trống</div>
            <div className='mt-5 text-center'>
              <Link
                to={path.home}
                className='bg-orange px-10 py-3 uppercase text-white transition-all hover:bg-orange/80'
              >
                Mua ngay
              </Link>
            </div>
